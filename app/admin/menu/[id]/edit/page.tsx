...
export default function EditMenuPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    hargaJual: "25000",
    deskripsi: "Ayam geprek pedas dengan sambal nista",
    tersedia: true,
    uom: "pcs",
    kuantitasUom: 1,
  });
  ...
  useEffect(() => {
    const fetchDetail = async () => {
      ...
      setFormData({
        ...
        grupItem: data.item_group || "",
        hargaJual: data.selling_price?.toString() || "",
        deskripsi: data.description || "",
        tersedia: data.disabled === 0,
        uom: data.stock_uom || "",
        kuantitasUom: 1,
      });
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Ubah detail umum menu</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Ubah gambar menu</CardDescription>
            </CardHeader>
            <CardContent>
              <div
